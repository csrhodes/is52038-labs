...
void HeapInsertTest::testInsertIntoHeap() {
  ...
  CPPUNIT_ASSERT_EQUAL_MESSAGE("The array should have a size of 6", 6UL, h.array.size());
  ...
  CPPUNIT_ASSERT_EQUAL_MESSAGE("The array should have a size of 7", 7UL, h.array.size());
