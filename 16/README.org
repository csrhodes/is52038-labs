...
* Random numbers submission
  Submit your work on random number generators, along with answers to
  the optional extra questions, to the submission area for this lab on
  the VLE by *18:00* on *Friday 23rd February*.  As usual, you may
